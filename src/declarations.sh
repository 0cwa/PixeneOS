...
VERSION[AVBROOT_SETUP]="91e49bc255672c98bf92d7d747f7b0cf12e01a80" # LineageOS SELinux compatibility fixes
...
ADDITIONALS[MAS_COMPATIBLE_SEPOLICY]="${ADDITIONALS_MAS_COMPATIBLE_SEPOLICY:-true}" # My AVBRoot setup
